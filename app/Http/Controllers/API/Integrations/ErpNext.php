...
{
	//$salesUrl = '/api/resource/Item/?limit_page_length=1000&fields=["name","is_stock_item","is_fixed_asset"]';
	...
	public function getSales(Request $request, Taxpayer $taxPayer, Cycle $cycle,$items,$customers,$row)
	{
