                    ...
                    <b-container>
                        <b-row>
                            <b-col>
                                ...
                                <b-form-checkbox switch v-model="data.is_import" name="check-button">
                                    <span v-if="data.is_import">Import</span>
                                    <span v-else>Export</span>
                                </b-form-checkbox>
                            </b-col>
                            <b-col>
                                <b-form-group :label="$t('commercial.number')">
                                    <b-input type="text" placeholder="Impex Number" v-model="data.code"/>
                                </b-form-group>
        ...
        <b-row>
            <b-col>
                <b-card title="Invoices">
                    <b-table hover :items="data.transactions" :fields="columnsTransactions">
        ...
        <b-row>
            <b-col>
                <b-card title="Expenses">
                    <b-table hover :items="data.expenses" :fields="columnsExpense">
                        <template slot="chart_id" slot-scope="data">
                            <b-form-select v-model="data.item.chart_id">
                                <option v-for="item in itemCharts" :key="item.key" :value="item.id">{{ item.name }}</option>
                            </b-form-select>
