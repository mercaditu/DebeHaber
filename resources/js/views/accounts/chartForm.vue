<template>
    <div>
        ...
        <b-row v-if="data.type == 1 && data.sub_type == 9">
            <b-col>
                <b-card :title="$t('commercial.fixedAssetGroup')" sub-title="State the life cycle the fixed assets related to this chart will have">
                    <b-form-group :label="$t('commercial.assetYears')">
                        <b-input required type="number" placeholder="Active Years" v-model.trim="data.asset_years"/>
                    </b-form-group>
                </b-card>
            </b-col>
        </b-row>
