        ...
        <div class="row">
            <table class="u-full-width">
                <tr>
                    ...
                    <td style="text-align:left"><b>{{ $header->setting!=null?$header->setting->agent_name:'' }}</b></td>
                </tr>
                <tr>
                    ...
                    <td style="text-align:left"><b>{{ $header->setting!=null?$header->setting->agent_taxid:'' }}</b></td>
                </tr>
                <tr>
        ...
        <table class="u-full-width">
            <tr>
                ...
                <td style="text-align:right">@lang('global.IssuedBy')
                    @auth
                        <b>{{ Auth::user()->name }}</b> | <a href="mailto:{{ Auth::user()->email }}">{{ Auth::user()->email }}</a>
                    @endauth
                </td>
            </tr>
        </table>
